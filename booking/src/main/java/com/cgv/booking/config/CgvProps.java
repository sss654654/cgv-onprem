...
public class CgvProps {
    ...
    private int warmupRounds;         // 기동 예열 반복 수(50건 배치 기준). 0 이면 예열하지 않음
    ...
    public int getWarmupRounds() { return warmupRounds; }
    public void setWarmupRounds(int v) { this.warmupRounds = v; }
}
