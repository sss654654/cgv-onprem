...
// 한 탭이 유지할 수 있는 가상 관객 예산 — 즉시 투입과 "예약된 러시"를 합친 상한이다.
//   러시를 예산에 안 넣으면 "예약 100 + 투입 N"이 다 들어가고 오픈 순간 러시가 말없이
//   잘린다(2026-08-31 — 이력에는 요청값이 그대로 찍혀 숫자가 안 맞아 보였다).
// 백엔드 한계가 아니라(부하 실측은 사용자 10,000명까지 여유) 브라우저 쪽 상한이다.
//   200명이면 생존 폴링 한 바퀴(200 ÷ 24청크 × 공개 경로 왕복 0.85초)가 약 7초로
//   틱(3초)을 넘지만, 재진입 가드가 겹침을 막고 생존 창(30초)에는 넉넉히 든다.
